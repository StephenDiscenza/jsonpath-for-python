...
def handle_search_json_exceptions(path: str, e: Exception, callingFunc: str) -> Exception:
    ...
    return JSONSearchError(f'{callingFunc} failed because an unexpected error occured in search_json. The path was: {path} and the error is: {repr(e)}')